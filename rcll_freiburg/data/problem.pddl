...
(:objects
    ...
    r1 r2 r3 - robot
    red_base_p10 grey_cap_p10 gate1_delivery_p10 red_base_p20 grey_cap_p20 gate3_delivery_p20 silver_base_p30 grey_cap_p30 gate1_delivery_p30 silver_base_p31 grey_cap_p31 gate1_delivery_p31 - step
)
(:init
    ...
    (has-step p30 silver_base_p30)
    (has-step p30 grey_cap_p30)
    (has-step p30 gate1_delivery_p30)
    (has-step p31 silver_base_p31)
    (has-step p31 grey_cap_p31)
    (has-step p31 gate1_delivery_p31)
    (initial-step red_base_p10)
    (initial-step red_base_p20)
    (initial-step silver_base_p30)
    (initial-step silver_base_p31)
    ...
    (step-at-machine silver_base_p30 bs)
    (step-at-machine grey_cap_p30 cs1)
    (step-at-machine gate1_delivery_p30 ds)
    (step-at-machine silver_base_p31 bs)
    (step-at-machine grey_cap_p31 cs1)
    (step-at-machine gate1_delivery_p31 ds)
    (step-precedes red_base_p10 grey_cap_p10)
    (step-precedes grey_cap_p10 gate1_delivery_p10)
    (step-precedes red_base_p20 grey_cap_p20)
    (step-precedes grey_cap_p20 gate3_delivery_p20)
    (step-precedes silver_base_p30 grey_cap_p30)
    (step-precedes grey_cap_p30 gate1_delivery_p30)
    (step-precedes silver_base_p31 grey_cap_p31)
    (step-precedes grey_cap_p31 gate1_delivery_p31)
