...
(:objects
    p70 p10 - product
    r1 r2 r3 - robot
    silver_base_p70 orange_ring_p70 yellow_ring_p70 blue_ring_p70 grey_cap_p70 gate3_delivery_p70 silver_base_p10 black_cap_p10 gate2_delivery_p10 - step
)
(:init
    ...
    (step-at-machine blue_ring_p70 rs1)
    (step-at-machine grey_cap_p70 cs1)
    ...
    (step-precedes silver_base_p70 orange_ring_p70)
    (step-precedes orange_ring_p70 yellow_ring_p70)
    (step-precedes yellow_ring_p70 blue_ring_p70)
    (step-precedes blue_ring_p70 grey_cap_p70)
    (step-precedes grey_cap_p70 gate3_delivery_p70)
    (step-precedes silver_base_p10 black_cap_p10)
    (step-precedes black_cap_p10 gate2_delivery_p10)
    (= (material-required silver_base_p70) 0)
    (= (material-required orange_ring_p70) 1)
    (= (material-required yellow_ring_p70) 0)
    (= (material-required blue_ring_p70) 2)
    (= (material-required grey_cap_p70) 0)
    (= (material-required gate3_delivery_p70) 0)
    (= (material-required silver_base_p10) 0)
    (= (material-required black_cap_p10) 0)
    (= (material-required gate2_delivery_p10) 0)
    (= (material-stored rs1) 0)
    (= (material-stored rs2) 0)
    (= (material-stored cs1) 0)
    (= (material-stored cs2) 0)
    (= (material-stored ds) 0)
    (= (material-stored bs) 0)
