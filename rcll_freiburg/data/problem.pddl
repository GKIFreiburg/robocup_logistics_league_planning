...
(:objects
    p10 p20 - product
    r1 r2 r3 - robot
    red_base_p10 grey_cap_p10 gate3_delivery_p10 black_base_p20 grey_cap_p20 gate1_delivery_p20 - step
)
(:init
    (cap-buffered cs1)
    (conveyor-full bs)
    ...
    (step-precedes grey_cap_p20 gate1_delivery_p20)
