...
(:objects
    p70 - product
    r1 r2 r3 - robot
    silver_base_p70 yellow_ring_p70 blue_ring_p70 green_ring_p70 grey_cap_p70 gate2_delivery_p70 - step
)
(:init
    ...
    (step-precedes silver_base_p70 yellow_ring_p70)
    ...
    (= (material-required blue_ring_p70) 0)
    (= (material-required green_ring_p70) 2)
