...
(:objects
    p40 - product
    r1 r2 r3 - robot
    black_base_p40 grey_cap_p40 gate2_delivery_p40 - step
)
(:init
    (has-step p40 black_base_p40)
    (has-step p40 grey_cap_p40)
    (has-step p40 gate2_delivery_p40)
    (initial-step black_base_p40)
    ...
    (step-at-machine black_base_p40 bs)
    (step-at-machine grey_cap_p40 cs1)
    (step-at-machine gate2_delivery_p40 ds)
    (step-precedes black_base_p40 grey_cap_p40)
    (step-precedes grey_cap_p40 gate2_delivery_p40)
    (= (material-required silver_base_p70) 0)
    (= (material-required green_ring_p70) 0)
    (= (material-required yellow_ring_p70) 1)
    (= (material-required orange_ring_p70) 2)
    (= (material-required black_cap_p70) 0)
    (= (material-required gate1_delivery_p70) 0)
    (= (material-required black_base_p40) 0)
    (= (material-required grey_cap_p40) 0)
    (= (material-required gate2_delivery_p40) 0)
...
(:goal (and
    (step-completed grey_cap_p40)
    (step-completed gate2_delivery_p40)
)))
