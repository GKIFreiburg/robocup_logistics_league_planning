...
(:objects
    p10 p60 p70 - product
    r1 r2 r3 - robot
    red_base_p10 grey_cap_p10 gate2_delivery_p10 silver_base_p60 blue_ring_p60 green_ring_p60 black_cap_p60 gate2_delivery_p60 black_base_p70 orange_ring_p70 green_ring_p70 blue_ring_p70 black_cap_p70 gate2_delivery_p70 - step
)
(:init
    (has-step p10 red_base_p10)
    (has-step p10 grey_cap_p10)
    (has-step p10 gate2_delivery_p10)
    (has-step p60 silver_base_p60)
    (has-step p60 blue_ring_p60)
    (has-step p60 green_ring_p60)
    (has-step p60 black_cap_p60)
    (has-step p60 gate2_delivery_p60)
    ...
    (step-at-machine silver_base_p60 bs)
    (step-at-machine blue_ring_p60 rs2)
    (step-at-machine green_ring_p60 rs1)
    (step-at-machine black_cap_p60 cs2)
    (step-at-machine gate2_delivery_p60 ds)
    (step-at-machine black_base_p70 bs)
    (step-at-machine orange_ring_p70 rs1)
    ...
    (step-precedes silver_base_p60 blue_ring_p60)
    (step-precedes blue_ring_p60 green_ring_p60)
    (step-precedes green_ring_p60 black_cap_p60)
    (step-precedes black_cap_p60 gate2_delivery_p60)
    (step-precedes black_base_p70 orange_ring_p70)
    (step-precedes orange_ring_p70 green_ring_p70)
    ...
    (= (material-required blue_ring_p60) 2)
    (= (material-required green_ring_p60) 1)
    (= (material-required orange_ring_p70) 0)
    (= (material-required green_ring_p70) 1)
    (= (material-required blue_ring_p70) 2)
...
(:goal (and
    ...
    (step-completed silver_base_p60)
    (step-completed blue_ring_p60)
    (step-completed green_ring_p60)
    (step-completed black_cap_p60)
    (step-completed gate2_delivery_p60)
