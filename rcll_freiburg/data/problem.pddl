...
(:objects
    p70 - product
    r1 r2 r3 - robot
    silver_base_p70 orange_ring_p70 blue_ring_p70 green_ring_p70 grey_cap_p70 gate2_delivery_p70 - step
)
(:init
    (conveyor-full rs1)
    (conveyor-full bs)
    ...
    (step-at-machine green_ring_p70 rs2)
    ...
    (step-precedes orange_ring_p70 blue_ring_p70)
    (step-precedes blue_ring_p70 green_ring_p70)
    (step-precedes green_ring_p70 grey_cap_p70)
    (step-precedes grey_cap_p70 gate2_delivery_p70)
    ...
    (= (material-required gate2_delivery_p70) 0)
