...
(:objects
    p10 p20 p30 p31 - product
    r1 r2 r3 - robot
    silver_base_p10 black_cap_p10 gate3_delivery_p10 black_base_p20 grey_cap_p20 gate3_delivery_p20 black_base_p30 grey_cap_p30 gate3_delivery_p30 black_base_p31 grey_cap_p31 gate3_delivery_p31 - step
)
(:init
    (has-step p10 silver_base_p10)
    (has-step p10 black_cap_p10)
    (has-step p10 gate3_delivery_p10)
    (has-step p20 black_base_p20)
    (has-step p20 grey_cap_p20)
    (has-step p20 gate3_delivery_p20)
    (has-step p30 black_base_p30)
    (has-step p30 grey_cap_p30)
    (has-step p30 gate3_delivery_p30)
    (has-step p31 black_base_p31)
    (has-step p31 grey_cap_p31)
    (has-step p31 gate3_delivery_p31)
    (initial-step silver_base_p10)
    (initial-step black_base_p20)
    (initial-step black_base_p30)
    (initial-step black_base_p31)
    ...
    (step-at-machine black_base_p20 bs)
    (step-at-machine grey_cap_p20 cs1)
    (step-at-machine gate3_delivery_p20 ds)
    (step-at-machine black_base_p30 bs)
    (step-at-machine grey_cap_p30 cs1)
    (step-at-machine gate3_delivery_p30 ds)
    (step-at-machine black_base_p31 bs)
    (step-at-machine grey_cap_p31 cs1)
    (step-at-machine gate3_delivery_p31 ds)
    (step-precedes silver_base_p10 black_cap_p10)
    (step-precedes black_cap_p10 gate3_delivery_p10)
    (step-precedes black_base_p20 grey_cap_p20)
    (step-precedes grey_cap_p20 gate3_delivery_p20)
    (step-precedes black_base_p30 grey_cap_p30)
    (step-precedes grey_cap_p30 gate3_delivery_p30)
    (step-precedes black_base_p31 grey_cap_p31)
    (step-precedes grey_cap_p31 gate3_delivery_p31)
...
(:goal (and
    ...
    (step-completed black_base_p20)
    (step-completed grey_cap_p20)
    (step-completed gate3_delivery_p20)
    (step-completed black_base_p30)
    (step-completed grey_cap_p30)
    (step-completed gate3_delivery_p30)
    (step-completed black_base_p31)
    (step-completed grey_cap_p31)
    (step-completed gate3_delivery_p31)
)))
