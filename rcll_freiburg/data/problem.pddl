...
(:objects
    p10 p60 - product
    r1 r2 r3 - robot
    silver_base_p10 grey_cap_p10 gate3_delivery_p10 red_base_p60 yellow_ring_p60 green_ring_p60 grey_cap_p60 gate1_delivery_p60 - step
)
(:init
    (has-step p10 silver_base_p10)
    (has-step p10 grey_cap_p10)
    (has-step p10 gate3_delivery_p10)
    (has-step p60 red_base_p60)
    (has-step p60 yellow_ring_p60)
    (has-step p60 green_ring_p60)
    (has-step p60 grey_cap_p60)
    (has-step p60 gate1_delivery_p60)
    (initial-step silver_base_p10)
    (initial-step red_base_p60)
    ...
    (step-at-machine red_base_p60 bs)
    (step-at-machine yellow_ring_p60 rs1)
    (step-at-machine green_ring_p60 rs2)
    (step-at-machine grey_cap_p60 cs1)
    (step-at-machine gate1_delivery_p60 ds)
    (step-precedes silver_base_p10 grey_cap_p10)
    (step-precedes grey_cap_p10 gate3_delivery_p10)
    (step-precedes red_base_p60 yellow_ring_p60)
    (step-precedes yellow_ring_p60 green_ring_p60)
    (step-precedes green_ring_p60 grey_cap_p60)
    (step-precedes grey_cap_p60 gate1_delivery_p60)
    (= (material-required yellow_ring_p60) 0)
    (= (material-required green_ring_p60) 0)
