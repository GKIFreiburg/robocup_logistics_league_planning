...
;p5
	...
	(step-precedes init_p5 ring1_p5)
	(has-step p5 ring1_p5)
	(step-at-machine ring1_p5 rs2)
	(= (material-required ring1_p5) 2)
	(step-precedes ring1_p5 ring2_p5)
	(has-step p5 ring2_p5)
	(step-at-machine ring2_p5 rs2)
	(= (material-required ring2_p5) 1)
	(step-precedes ring2_p5 cap_p5)
	(has-step p5 cap_p5)
	(step-at-machine cap_p5 cs2)
