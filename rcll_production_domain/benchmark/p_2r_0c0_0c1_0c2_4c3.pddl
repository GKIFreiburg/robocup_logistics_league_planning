(define (problem p_2r_0c0_0c1_0c2_4c3)
...
(:objects
	...
	p4 - product
	init_p4  ring1_p4 ring2_p4 ring3_p4 cap_p4 delivery_p4 - step
...
(:init
	...
	(= (material-required ring2_p1) 0)

	(has-step p1 ring3_p1)
	(step-precedes init_p1 ring3_p1)
	(step-at-machine ring3_p1 rs1)
