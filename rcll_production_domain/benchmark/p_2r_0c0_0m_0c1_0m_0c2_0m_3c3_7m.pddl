(define (problem p_2r_0c0_0m_0c1_0m_0c2_0m_3c3_7m)
...
(:objects
	...
	; products
	p1 - product
	init_p1  ring1_p1 ring2_p1 ring3_p1 cap_p1 delivery_p1 - step
...
(:init
	...
	(has-step p1 ring2_p1)
	(step-precedes init_p1 ring2_p1)
	(step-at-machine ring2_p1 rs2)
	(= (material-required ring2_p1) 2)

	(has-step p1 ring3_p1)
	(step-precedes init_p1 ring3_p1)
	(step-at-machine ring3_p1 rs2)
	(= (material-required ring3_p1) 0)

	(has-step p1 cap_p1)
	(step-precedes  ring3_p1 cap_p1)
	...
	(step-at-machine ring2_p2 rs1)
	(= (material-required ring2_p2) 0)

	(has-step p2 ring3_p2)
	(step-precedes init_p2 ring3_p2)
	(step-at-machine ring3_p2 rs2)
	(= (material-required ring3_p2) 2)
