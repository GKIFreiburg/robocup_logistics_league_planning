...
(:objects
	...
	; products
	p1 - product
	init_p1  ring1_p1 ring2_p1 cap_p1 delivery_p1 - step

	p2 - product
	init_p2  ring1_p2 ring2_p2 cap_p2 delivery_p2 - step

	p3 - product
	init_p3  ring1_p3 ring2_p3 cap_p3 delivery_p3 - step
