...
class ActionInsertProduct : public rosplan_interface_freiburg::AsyncActionInterface
{
public:
        ActionInsertProduct()
        {
                ros::NodeHandle nh;
                log_prefix_ = "[InsertProduct] ";
                skiller_client_ = std::make_shared<SkillerClient>(nh, "skiller", /* spin thread */true);
                std::string log_prefix_ = "[InsertProduct] ";
                ...
                dispatch_subscriber_ = nh.subscribe("/kcl_rosplan/action_dispatch", 10, &ActionInsertProduct::dispatchCB, this);
                sub_ring_info_ = nh.subscribe("rcll/ring_info", 10, &ActionInsertProduct::ring_info_cb, this);
...
{
        ros::init(argc, argv, "action_insert_product");
        ros::NodeHandle n;

        ActionInsertProduct action;
